...
\begin{minipage}[t]{0.55\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{two triangles have two angles of the one reſpectively equal to two angles of the other,} (\hspace{-1ex}$\img{yellow_angle_13} \bequals \img{yellow_angle_13}$ \textit{and} $\img{red_angle_12} \bequals \img{black_and_blue_angles}$\hspace{-1ex}),
    \end{center}
    \vspace{1ex}
