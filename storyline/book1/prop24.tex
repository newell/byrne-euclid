...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{two triangles have two ſides of one reſpectively\\ equal to two ſides of the other} (\hspace{-1ex}$\blueline$ \textit{to} $\bluethinline$\\ \textit{and} $\dottedredline$ \textit{to} $\redthinline$\hspace{-1ex}), \textit{and if one of the angles}\\
    \end{center}
    \vspace{1ex}
