...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{two triangles have two ſides of the one reſpectively\\ equal to two ſides of the other}, (\hspace{-1ex}$\redline$ \textit{to} $\redline$\\ \textit{and} $\blueline$ \textit{to} $\blueline$\hspace{-1ex}) \textit{and the angles} (\hspace{-1ex}$\img[0][0][20]{yellow_angle}$ \textit{and}
    \end{center}
