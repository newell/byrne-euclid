...
\begin{minipage}[t]{0.55\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{T}}{}O \textit{draw a ſtraight line\\ perpendicular to a given indefinite ſtraight line} (\hspace{-1ex}$\bimg{black_and_yellow_lines}$\hspace{-1ex}) \textit{from a given} (\textit{point}$\img{point_blue_and_red_lines}$\hspace{-1ex}), \textit{without}.
    \end{center}
\end{minipage}
