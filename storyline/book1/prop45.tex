...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{T}}{}O \textit{conſtruct a parallelogram equal to a given\\ rectilinear figure} (\hspace{-1ex}$\img{triangles}$\hspace{-1ex}) \textit{and having an angle\\ equal to a given rectilinear angle} (\hspace{-1ex}$\img{red_angle_22}$\hspace{-1ex}).
    \end{center}
