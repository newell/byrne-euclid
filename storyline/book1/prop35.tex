...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{P}}{}ARALLELOGRAMS \textit{on the ſame baſe, and\\ between the ſame parallels, are} (\textit{in area}) \textit{equal}.
    \end{center}
