...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{T}}{}RIANGLES (\hspace{-1ex}$\img[0][0][22]{large_yellow_triangle}$ \textit{and} $\img{small_yellow_and_black_triangles}$\hspace{-1ex}) \textit{on the ſame baſe}\\ (\hspace{-1ex}$\blackline$\hspace{-1ex}) \textit{and between the ſame parallels are equal}.
    \end{center}
