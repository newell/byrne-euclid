...
\begin{minipage}[t]{0.55\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{E}}{}QUAL \textit{triangles} (\hspace{-2ex}$\img[0][0][40]{yellow_triangle}$ \textit{and} $\img[0][0][40]{red_triangle_2}$\hspace{-2ex}) \textit{on equal baſes, and}
    \end{center}
