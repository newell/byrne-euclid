...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{T}}{}O \textit{conſtruct a parallelogram equal to a given\\ triangle} $\img[0][0][40]{black_blue_and_yellow_triangles_2}$ \textit{and having an angle equal to a\\ given rectilinear angle} $\img{yellow_angle_22} \bperiod$
    \end{center}
