...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{I}}{}N \textit{any iſoſceles triangle} $\img{isosceles_triangle_2}$ \textit{if the equal ſides be\\ produced, the external angles at the baſe are equal,\\ and the internal angles at the baſe are alſo equal}.
    \end{center}
