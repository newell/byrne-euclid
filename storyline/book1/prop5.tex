...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{I}}{}N \textit{any iſoſceles triangle}\\ $\img{isosceles_triangle_2}$ \textit{if the equal ſides be\\ produced, the external angles at}
    \end{center}
