...
\begin{minipage}[t]{0.55\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{T}}{}RIANGLES (\hspace{-1ex}$\img[0][0][20]{red_triangle}$ \textit{and} $\img[0][0][20]{blue_triangle}$\hspace{-1ex})\\ \textit{on equal baſes and between the ſame parallels are equal}.
    \end{center}
\end{minipage}%
\hfill
