...
\begin{minipage}[t]{0.55\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{the ſquare of one ſide} (\hspace{-1ex}$\redline$\hspace{-1ex}) \textit{of a triangle is equal to the ſquares of the other two ſides} (\hspace{-1ex}$\blueline$ \textit{and} $\blackline$\hspace{-1ex}), \textit{the angle} (\hspace{-1ex}$\img{red_angle_42}$\hspace{-1ex}) \textit{ſubtended by that}
    \end{center}
