...
\begin{minipage}[t]{0.55\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{S}}{}TRAIGHT \textit{lines} (\hspace{-1ex}$\img{red_and_blue_lines}$\hspace{-1ex}) \textit{which are parallel to the ſame ſtraight line} (\hspace{-1ex}$\yellowline$\hspace{-1ex}), \textit{are parallel to one another}.
    \end{center}
\end{minipage}%
\hfill
