...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{I}}{}N \textit{a right angled triangle} (\hspace{-1ex}$\img{center_triangle}$\hspace{-1ex}) \textit{the ſquare on the hypotenuſe} (\hspace{-1ex}$\redline$\hspace{-1ex}) \textit{is equal to}
    \end{center}
