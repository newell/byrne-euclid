...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{F}}{}ROM \textit{a given point}\\ (\hspace{-1ex}$\bimg{black_and_red_lines}$\hspace{-1ex}), \textit{in a given ſtraight\\ line} (\hspace{-1ex}$\bimg{black_and_red_lines}$\hspace{-1ex}), \textit{to draw a}
    \end{center}
    \textit{perpendicular}.
\end{minipage}%
\hfill
