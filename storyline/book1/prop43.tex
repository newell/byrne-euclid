...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{T}}{}HE \textit{complements} $\img[0][0][30]{blue_parallelogram}$ \textit{and} $\img{black_parallelogram}$ \textit{of the parallelograms which are about the diagonal of a parallelogram are equal}.
    \end{center}
\end{minipage}
