...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{a parallelogram} $\img[0][0][30]{parallelogram}$ \textit{and a triangle} $\img{blue_red_and_yellow_triangles}$\\ \textit{are upon the ſame baſe} (\hspace{-1ex}$\blackline$\hspace{-1ex}) \textit{and between the\\ ſame parallels} (\hspace{-1ex}$\dottedblackline$ \textit{and} $\blackline$\hspace{-1ex}), \textit{the}\\
    \end{center}
