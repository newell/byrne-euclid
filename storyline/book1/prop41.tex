...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{a parallelogram} $\img[0][0][30]{parallelogram}$\\ \textit{and a triangle} $\img{blue_red_and_yellow_triangles}$
    \end{center}
