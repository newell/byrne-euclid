...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{T}}{}O \textit{biſect a given rectilinear\\ angle} (\hspace{-1ex}$\img{blue_and_yellow_angles_2}$\hspace{-1ex}).
    \end{center}
\end{minipage}%
\hfill
