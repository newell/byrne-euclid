...
\begin{minipage}[t]{0.55\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{from any point} (\hspace{-1ex}$\img{point_black_and_yellow_lines}$\hspace{-1ex}) \textit{within a triangle} $\img[0][0][30]{triangle_10}$ \textit{ſtraight}
    \end{center}
