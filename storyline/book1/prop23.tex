...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{A}}{}T \textit{a given point} (\hspace{-1ex}$\img{point_black_and_yellow_lines_2}$\hspace{-1ex}) \textit{in a given ſtraight line}\\ (\hspace{-1ex}$\blacklines$\hspace{-1ex}), \textit{to make an angle equal to a given\\ rectilineal angle} (\hspace{-1ex}$\img{red_angle_10}$\hspace{-1ex}).
    \end{center}
