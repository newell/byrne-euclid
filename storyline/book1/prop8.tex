...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{two triangles have two ſides of the one reſpectively equal to two ſides of the other} (\hspace{-1ex}$\blueline \bequals \blueline$ \textit{and} $\redline \bequals \redline$\hspace{-1ex}), \textit{and alſo their baſes}
    \end{center}
