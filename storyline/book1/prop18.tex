...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{I}}{}N \textit{any triangle} $\img[0][0][30]{triangle_7}$ \textit{if one ſide} $\img[0.5][0][30]{red_lines_2}$ \textit{be\\ greater than another} $\blueline \bcomma$ \textit{the angle oppoſite\\ to the greater ſide is greater than the angle to the\\ oppoſite to the leſs. i.e.} $\img[0][0][20]{black_and_red_angles} \bgt \img{yellow_angle_9} \bperiod$
    \end{center}
