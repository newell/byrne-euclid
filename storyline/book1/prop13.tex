...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{W}}{}HEN \textit{a ſtraight line} (\hspace{-1ex}$\yellowline$\hspace{-1ex})\\ \textit{ſtanding upon another ſtraight line} (\hspace{-1ex}$\redline$\hspace{-1ex}) \textit{makes angles with}
    \end{center}
