...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{T}}{}O \textit{divide a ſtraight line} (\hspace{-1ex}$\bimg{blue_red_and_yellow_line_2}$\hspace{-1ex}) \textit{ſimilarly to a\\ given divided line} (\hspace{-1ex}$\bimg{thin_blue_red_and_yellow_line}$\hspace{-1ex}).
    \end{center}
