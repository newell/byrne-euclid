...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{ſimilar and ſimilarly poſited parallelograms}\\ (\hspace{-1ex}$\img{red_parallelogram_6}$ \textit{and} $\img[0][0][40]{gnomon}$\hspace{-1ex}) \textit{have a common angle,\\ they are about the ſame diagonal}.
    \end{center}
