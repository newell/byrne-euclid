...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{two triangles} (\hspace{-1ex}$\img{left_triangle_13}$ \textit{and}\\ $\img[0][0][20]{right_triangle_13}$\hspace{-1ex}), \textit{have two ſides}
    \end{center}
