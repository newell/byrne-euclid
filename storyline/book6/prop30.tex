...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{T}}{}O \textit{cut a given finite ſtraight line} (\hspace{-1ex}$\bimg{red_and_dotted_red_line_7}$\hspace{-1ex}),\\ \textit{in extreme and mean ratio}.
    \end{center}
