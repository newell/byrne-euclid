...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{I}}{}N \textit{equal circles} (\hspace{-1ex}$\img{red_circle_2} \bcomma \img{blue_circle_4}$\hspace{-1ex}), \textit{angles, whether\\ at the centre or circumference, are in the ſame ratio\\ to one another as the arcs on which they ſtand}
    \end{center}
    \vspace{2.5ex}
