...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{I}}{}N \textit{any parallelograms} (\hspace{-1ex}$\img{parallelogram_4}$\hspace{-1ex}) \textit{the parallelograms}\\ (\hspace{-1ex}$\img[0][0][20]{red_parallelogram_5}$ \textit{and} $\img[0][0][20]{blue_parallelogram_6}$\hspace{-1ex}) \textit{which are about the diagonal\\ are ſimilar to the whole, and to each other}.
    \end{center}
