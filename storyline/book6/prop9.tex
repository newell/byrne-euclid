...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{F}}{}ROM \textit{a given ſtraight line}\\ (\hspace{-1ex}$\bimg{yellow_and_dotted_yellow_line_5}$\hspace{-1ex}) \textit{to cut off\\ any required part}.
    \end{center}
