...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{T}}{}HE \textit{rectangle contained by the diagonals of a\\ quadrilateral figure inſcribed in a circle, is\\ equal to both the rectangles contained by\\ oppoſite ſides}.
    \end{center}
