...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        PART I.\\
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{four ſtraight line be proportional}\\ (\hspace{-1ex}$\blackline \bcolon \blueline \bbcolon \redline \bcolon \yellowline$\hspace{-1ex}), \textit{the\\ ſimilar rectilinear figures ſimilarly deſcibed on\\ them are alſo proportional}.
    \end{center}
