...
\begin{minipage}{0.67\textwidth}
    ...
    \begin{center}
        ...
        \hfill\\
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{R}}{}ECTILINEAR figures are ſaid to be ſimilar, when they have their ſeveral angles equal, each to each, and the ſides about the equal angles proportional.
    \end{center}
\end{minipage}%
