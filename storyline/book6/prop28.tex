...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{T}}{}O \textit{divide a given ſtraight line} (\hspace{-1ex}$\bimg{dotted_red_blue_and_dotted_blue_line}$\hspace{-1ex}) \textit{ſo that\\ the rectangle contained by its ſegments may be equal\\ to a given area, not exceeding the ſquare of half\\ the line}.
    \end{center}
