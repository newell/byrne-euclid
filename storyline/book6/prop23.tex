...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{E}}{}QUIANGULAR \textit{parallelograms} (\hspace{-1ex}$\img{yellow_parallelogram_5}$ \textit{and} $\img{blue_parallelogram_5}$\hspace{-1ex}) \textit{are to one another in a ratio compounded of the ratios of their ſides}.
    \end{center}
\end{minipage}%
\hfill
