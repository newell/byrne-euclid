...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{S}}{}IMILAR \textit{polygons may be divided into the ſame number of ſimilar triangles, each ſimilar pair of which are proportional to the polygons; and the polygons are to each other in the duplicate ratio of their homologous ſides}.
    \end{center}
\end{minipage}
