...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{T}}{}O \textit{find a mean proportional\\ between two given ſtraight\\ lines} $\left\{\hspace{-1ex}\img[0][0][40]{dotted_blue_and_red_lines}\hspace{-1ex}\right\}$.
    \end{center}
\end{minipage}%
\hfill
