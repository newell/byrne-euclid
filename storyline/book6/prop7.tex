...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{two triangles} (\hspace{-1ex}$\img{left_triangle_12}$ \textit{and} $\img{right_triangle_12}$\hspace{-1ex}) \textit{have one angle in each}
    \end{center}
