...
\begin{minipage}{\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{he firſt be to the ſecond as the third to the fourth, and if the firſt be a multiple, or a\\ part of the ſecond; the third is the ſame multiple, or the ſame part of the fourth}.
    \end{center}
