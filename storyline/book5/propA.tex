...
\begin{minipage}{\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{the firſt of the four magnitudes has the ſame ratio to the ſecond which the third has\\ to the fourth, then if the firſt be greater than the ſecond, the third is alſo greater than\\ the fourth; and if equal, equal; if leſs, leſs}.
    \end{center}
