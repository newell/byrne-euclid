...
\begin{minipage}{\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{E}}{}QUAL \textit{magnitudes have the ſame ratio to the ſame magnitude,\\ and the ſame has the ſame ratio to equal magnitudes}.
    \end{center}
\end{minipage}
