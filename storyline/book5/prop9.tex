...
\begin{minipage}{\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{M}}{}AGNITUDES \textit{which have the ſame ratio to the ſame magnitude are\\ equal to one another; and thoſe to which the ſame magnitude has the\\ ſame ratio are equal to one another}.
    \end{center}
\end{minipage}
