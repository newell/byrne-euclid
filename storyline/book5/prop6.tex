...
\begin{minipage}{\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{two magnitudes be equimultiples of two others, and if equimultiples\\ of theſe be taken from the firſt two, the remainders are either equal to\\ theſe others, or equimultiples of them}.
    \end{center}
\end{minipage}
