...
\begin{minipage}{\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{any number of magnitudes be proportionals as one of the\\ antecedents is to its conſequent, ſo ſhall all the antecedents\\ taken together be to all the conſequents}.
    \end{center}
\end{minipage}
