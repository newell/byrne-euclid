...
\begin{minipage}{\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{T}}{}HAT \textit{magnitude which has a greater ratio than another has unto the ſame magnitude, is the greater of the two: and that magnitude to which the ſame has a greater ratio than it has unto another magnitude, is the leſs of the two}.
    \end{center}
\end{minipage}
