...
\begin{minipage}{\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{one magnitude be the ſame multiple of another, which a magnitude taken from the firſt is of a magnitude taken from the other the remainder ſhall be the ſame multiple of the remainder, that the whole is of the whole}.
    \end{center}
\end{minipage}
