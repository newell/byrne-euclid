...
\begin{minipage}{\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{four magnitudes be proportionals, they are alſo proportionals by converſion: that is,\\ the firſt is to its exceſs above the ſecond, as the third is to its exceſs above the fourth}.
    \end{center}
