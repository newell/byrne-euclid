...
\begin{minipage}{\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{a whole magnitude be to a whole, as a magnitude taken from the firſt, is to a\\ magnitude taken from the other; the remainder ſhall be to the remainder, as\\ the whole to the whole}.
    \end{center}
