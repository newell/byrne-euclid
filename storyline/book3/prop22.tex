...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{T}}{}HE \textit{oppoſite angles} $\img[0][0][30]{red_and_blue_angles}$ \textit{and} $\img{yellow_and_black_angles_2} \bcomma \img[0][0][20]{black_and_blue_angles_3}$ \textit{and}
    \end{center}
