...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{a ſtraight line} (\hspace{-1ex}$\blackline$\hspace{-1ex})\\ \textit{drawn through the centre of a circle} $\img{blue_circle_2}$ \textit{biſects a chord}
    \end{center}
    \raggedright (\hspace{-1ex}$\bimg{red_and_dotted_red_line_3}$\hspace{-1.5ex}) \textit{which does not paſs through the centre, it is perpendicular to it; or, if perpendicular to it, it biſects it}.
\end{minipage}%
