...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \end{center}
    (\hspace{-1ex}$\bimg{red_and_dotted_red_line_3}$\hspace{-1.5ex}) \textit{which does not paſs through the centre, it is perpendicular to it; or, if perpendicular to it, it biſects it}.
\end{minipage}%
\hfill
