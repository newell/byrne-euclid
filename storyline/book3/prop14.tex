...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{E}}{}QUAL \textit{ſtraight lines} $\left\{\begin{aligned} \bimg{yellow_and_dotted_yellow_line_4} \\[-2ex] \bimg{red_and_dotted_red_line_5} \end{aligned}\right\}$ \textit{inſcribed in}
    \end{center}
