...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{A}}{} \textit{ſtraight line} (\hspace{-1ex}$\redline$\hspace{-1ex}) \textit{joining two points in the\\ circumference of a circle} $\img{red_circle_2} \bcomma$ \textit{lies wholly\\ within the circle}.
    \end{center}
