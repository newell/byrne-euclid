...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{a ſtraight line be divided} $\bimg{bottom_red_blue_and_yellow_lines}$ \textit{into two equal parts and alſo} $\bimg{bottom_red_blue_and_yellow_lines}$ \textit{into two unequal parts, the rectangle}
    \end{center}
\end{minipage}
