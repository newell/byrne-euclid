...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{T}}{}O \textit{divide a given ſtraight line} $\bimg{red_and_dotted_red_line_2}$ \textit{in ſuch a\\ manner, that the rectangle contained by the whole\\ line and one of its parts may be equal to the ſquare\\ of the other}.
    \end{center}
    \[
