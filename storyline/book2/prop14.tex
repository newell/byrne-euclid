...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{T}}{}O \textit{draw a right line of which the ſquare ſhall be equal to a given rectilinear figure}. \textit{To draw} $\blueline$ \textit{ſuch that}
    \end{center}
