...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{I}}{}F \textit{a ſtraight line be divided into two equal parts} $\bimg{blue_and_red_yellow_lines} \bcomma$ \textit{and alſo into two unequal parts} $\bimg{blue_yellow_and_red_lines} \bcomma$ \textit{the ſquares of the unequal}
    \end{center}
\end{minipage}
