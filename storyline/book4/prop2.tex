...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{O}}{}N \textit{a given cirle} $\img[0][0][30]{black_circle}$ \textit{to inſcribe a triangle\\ equiangular to a given triangle}.
    \end{center}
