...
\begin{minipage}[t]{0.54\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=3, loversize=1, nindent=0pt]{\euclidinitials{O}}{}N \textit{a given circle} $\img[0][0][30]{black_circle}$ \textit{to\\ inſcribe a triangle equiangular}
    \end{center}
    \vspace{1ex}
