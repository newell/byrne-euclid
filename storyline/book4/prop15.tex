...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{T}}{}O \textit{inſcribe an equilateral and equiangular hexagon\\ in a given circle} $\img{yellow_circle} \bperiod$
    \end{center}
