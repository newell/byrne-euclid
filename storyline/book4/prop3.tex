...
\begin{minipage}[t]{0.64\textwidth}
    ...
    \begin{center}
        \raggedright \lettrine[lines=4, loversize=1, nindent=0pt]{\euclidinitials{A}}{}BOUT \textit{a given cirle} $\img[0][0][30]{red_circle_2}$ \textit{to circumſcribe\\ a triangle equiangular to a given triangle}.
    \end{center}
